...
(function(window) {
    ...
    this.fields.forEach(function(fld) {
      if (fld.hasAttribute("data-input-trigger")) {
        var input =
          ...
          fld.querySelector('input[type="button"]') ||
        ...
        switch (input.tagName.toLowerCase()) {
          ...
          case "input":
            [].slice
              .call(
                fld.querySelectorAll('input[type="radio"]') ||
                  fld.querySelector('input[type="button"]')
              )
  ...
  FForm.prototype._nextField = function(backto) {
    ...
    this.navdir =
      backto !== undefined ? (backto < this.current ? "prev" : "next") : "next";
  ...
  FForm.prototype._updateNav = function() {
    if (this.options.ctrlNavDots) {
      classie.remove(
        this.ctrlNav.querySelector("button.fs-dot-current"),
        "fs-dot-current"
      );
